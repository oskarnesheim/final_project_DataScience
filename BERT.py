...
df = df[df['genre'].isin(['Action', 'Drama', 'Comedy', 'Horror', 'Animation', 'Adventure', 'Thriller', 'Romance', 'Crime',
                         'Science Fiction', 'Family', 'Fantasy', 'Mystery', 'Documentary', 'Western', 'War', 'Music', 'History', 'TV Movie'])]
